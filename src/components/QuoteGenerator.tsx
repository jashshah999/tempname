  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="glass-card p-8 mb-8">
        ...
        {/* Input Options */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-green-600 mb-4">Step 1: Choose Input Method</h3>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <div className="flex-1 w-full">
              <textarea
                value={inputText}
                onChange={(e) => setInputText(e.target.value)}
                className="w-full px-3 py-2 bg-neutral-800/50 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-green-700/30 focus:border-green-700/30 text-white h-32"
                placeholder="Enter product details, specifications, and requirements..."
              />
            </div>
            <div className="text-green-600 font-medium">OR</div>
            <div className="flex-1 w-full">
              <button
        ...
        {/* Generate Options */}
        <div>
          <h3 className="text-lg font-semibold text-green-600 mb-4">Step 2: Generate Quote</h3>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="text-green-600 font-medium self-center">OR</div>
            <button
      ...
      {generatedQuote && (
        <div className="glass-card p-8">
          ...
          <div className="bg-neutral-800/50 border border-neutral-700 rounded-md p-4 text-white whitespace-pre-wrap">
            {generatedQuote}
          </div>
        </div>
      )}
